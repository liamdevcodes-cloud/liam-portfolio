...
function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-40 border-t border-slate-200/80 bg-white/90 py-4 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-950/90">
